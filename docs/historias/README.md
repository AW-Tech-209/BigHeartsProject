...
| [HU-408](./HU-408-identidad-visual-y-pantallas-de-acceso.md) | Identidad visual y pantallas de acceso              | ✅ Completada                         |
| [HU-409](./HU-409-formularios-de-acceso-redisenados.md)      | Formularios de login y registro rediseñados         | ✅ Completada                         |
...
**Cierre de Fase 1 · diseño, lote 2 — pantallas con sesión (HU-412 – HU-414).** El lote 1 rehízo
login/registro/recuperación; este rehace las vistas que se usan ya con la sesión abierta, contra el
mockup de referencia y la identidad de HU-408. Frontend en su totalidad.

```
HU-414 (<TarjetaAula>: estados, cupos, fechas, microcopy) ──► HU-412 (catálogo + filtros)
                                                           └─► HU-413 (panel de inicio por rol)
```
